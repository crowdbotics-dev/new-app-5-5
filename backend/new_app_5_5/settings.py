"""
Django settings for new_app_5_5 project.
...
WSGI_APPLICATION = 'new_app_5_5.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "new-app-5 Support <support@new-app-5-5.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "new_app_5_5 API",
    "DESCRIPTION": "API documentation for new_app_5_5 App",
    "VERSION": "v1",
}
